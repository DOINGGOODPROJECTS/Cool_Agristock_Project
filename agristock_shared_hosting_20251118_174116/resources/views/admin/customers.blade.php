    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">@lang('locale.customer', ['suffix'=>'s'])</h4>

                <div class="page-title-right">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#new-customer"><i class="fas fa-user-plus"></i> @lang('locale.add')</button>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <x-edit-user :user="$item" :groups="$groups" :entity="__('locale.customer', ['suffix'=>''])"></x-edit-user>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-primary-subtle">
                    <h5 class="modal-title">@lang('locale.customer', ['suffix'=>''])</h5>
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-grid gap-3">        
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Ex: Paul Sylla" required/> <label for="floatingInput">@lang('locale.company') / @lang('locale.name') <span class="text-danger">*</span></label>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="username" name="username" placeholder="Ex: Pseudo"/> <label for="floatingInput">@lang('locale.username')</label>
                                    </div>                                  
                                </div>                                
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-floating">
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Ex: contact@agristock.com"/> <label for="floatingInput">@lang('locale.email')</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                ...
                                <label for="groupId">@lang('locale.category', ['suffix'=>app()->getLocale() == 'en' ? 'y' : '']) <span class="text-danger">*</span></label>
                            </div>
                        </div>
                    </div>
