                        ...
                        <div class="d-grid gap-3">
                            ...
                            <div class="row">
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="thingsboard_device_id" name="thingsboard_device_id" placeholder="Ex: 6a1e...-ThingsBoard-Device-Id"/> <label for="floatingInput">@lang('locale.thingsboard_device_id')</label>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-floating">
                                        <input type="number" min="1" class="form-control" id="stale_threshold_minutes" name="stale_threshold_minutes" value="15" placeholder="15"/> <label for="floatingInput">@lang('locale.stale_threshold_minutes')</label>
                                    </div>
                                </div>
                            </div>
